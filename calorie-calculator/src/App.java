...
public class App {
    ...
    // Activity multipliers for calorie needs
    ...
    public static void main(String[] args) {
        ...
        scanner.nextLine(); // consume leftover newline after numeric input
    ...
    // Calculates BMR based on gender, age, weight, and height
